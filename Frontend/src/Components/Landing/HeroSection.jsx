...
export default function HeroSection() {
    return (
        <div className='p-10 space-y-3  w-3/4'>
            ...
            <div className='flex  items-center justify-center flex-row gap-5'>
                <button className=' btn btn-lg  w-48 btn-primary  hover:text-white-400'> Create a Workspace </button>
                <button className='btn btn-lg btn-primary  w-48 hover:text-white-400 text-slate-300' > Explore Workspace </button>
            </div>
        </div>
    )
}
